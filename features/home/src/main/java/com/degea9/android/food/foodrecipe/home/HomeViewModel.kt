...
class HomeViewModel @Inject constructor(
    ...
    init {
        ...
        val listCategory = listOf<String>("popularity","healthiness","price","random","cholesterol","carbs")
        categoryRecipesList = listCategory.asFlow().flatMapMerge {categoryName->
            getPopularRecipeUsecase.getRecipes(categoryName).map { CategoryRecipes(categoryName,recipes = it) }
